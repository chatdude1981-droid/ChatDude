...
const DEFAULT_ROOMS = [
  ...
  {
    id: "room-introductions",
    slug: "introductions",
    name: "Introductions",
    description: "Meet new people and break the ice.",
    topic: "Say hi, share your vibe, and find your people.",
    adultOnly: false,
    managedBySite: true,
    createdAt: new Date().toISOString(),
    createdBy: "system",
  ...
  },
  {
    ...
    slug: "music",
    name: "Music",
    description: "Tracks, artists, playlists, and live-show talk.",
    topic: "Share what is on repeat and discover new favorites.",
    adultOnly: false,
    managedBySite: true,
    createdAt: new Date().toISOString(),
    createdBy: "system",
  ...
  },
  {
    ...
    slug: "creators",
    name: "Creators",
    description: "For builders, artists, writers, and side-project people.",
    topic: "Talk content, design, coding, and making things that matter.",
    adultOnly: false,
    managedBySite: true,
    createdAt: new Date().toISOString(),
    createdBy: "system",
  ...
  },
  {
    ...
    slug: "tech",
    name: "Tech",
    description: "Apps, AI, gadgets, and internet culture.",
    topic: "Swap tools, trends, and opinions on what is next.",
    adultOnly: false,
    managedBySite: true,
    createdAt: new Date().toISOString(),
    createdBy: "system",
  ...
  },
  {
    ...
    slug: "late-night",
    name: "Late Night",
    description: "Looser, slower chat for people still awake.",
    topic: "Night owl energy, winding down, and whatever is on your mind.",
    adultOnly: true,
    managedBySite: true,
    createdAt: new Date().toISOString(),
    createdBy: "system",
  ...
  },
  {
    ...
    slug: "age-18-24",
    name: "18-24",
    description: "Adult chat for the younger crowd.",
    topic: "College years, early work life, dating, and figuring life out.",
    adultOnly: true,
    managedBySite: true,
    createdAt: new Date().toISOString(),
    createdBy: "system",
  ...
  },
  {
    ...
    slug: "age-25-34",
    name: "25-34",
    description: "Adult chat for mid-twenties to early-thirties life.",
    topic: "Career moves, relationships, routines, goals, and burnout recovery.",
    adultOnly: true,
    managedBySite: true,
    createdAt: new Date().toISOString(),
    createdBy: "system",
  ...
  },
  {
    ...
    slug: "age-35-plus",
    name: "35+",
    description: "Adult chat for a more established crowd.",
    topic: "Life experience, perspective, family, reinvention, and grounded conversation.",
    adultOnly: true,
    managedBySite: true,
    createdAt: new Date().toISOString(),
    createdBy: "system",
